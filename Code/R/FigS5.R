...
plot_recall_vs_count <- function(data, title, y_label_l, y_label_r, x_label, omega_text) {
  ...
  ggplot(data) +
    ...
    # Add Omega Annotation
    annotate("text", x = 5.5, y = 0.7, label = omega_text, size = 5, color = "black", hjust = 1) +
...
ran_gene_pair_count <- list(omega001 = 0, omega005 = 0, omega01 = 0)
...
# Generate plots for omega 0.01
a1 <- plot_recall_vs_count(f_recall_rate$omega001, 'Reaction-gene pair perspective', "Recall Rate", "Number of reaction-gene pairs", "", "omega = 0.01")
a2 <- plot_recall_vs_count(s_recall_rate$omega001, 'Reaction-centric perspective',   "Recall Rate", "Number of reactions",           "", "omega = 0.01")
a3 <- plot_recall_vs_count(t_recall_rate$omega001, 'Gene-centric perspective',       "Recall Rate", "Number of genes",               "", "omega = 0.01")
...
c1 <- plot_recall_vs_count(f_recall_rate$omega01, '', "Recall Rate", "Number of reaction-gene pairs", "Threshold", "omega = 0.1")
c2 <- plot_recall_vs_count(s_recall_rate$omega01, '', "Recall Rate", "Number of reactions",           "Threshold", "omega = 0.1")
c3 <- plot_recall_vs_count(t_recall_rate$omega01, '', "Recall Rate", "Number of genes",               "Threshold", "omega = 0.1")
...
ggsave("Results/figures/Sup Fig 5.svg", combined_plot, width = 12, height = 13)
